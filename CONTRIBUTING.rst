...
Thank you for your help improving **ee-preproc**!

**ee-preproc** uses `nox <https://nox.thea.codes/en/stable/>`__ to automate several development-related tasks.
...
First off, you'll need your own copy of **ee-preproc** codebase. You can clone it for local development like so:
...
.. code-block:: console
   ...
   git clone https://github.com/<YOUR USERNAME>/ee-preproc
   cd ee-preproc
...
This will install the **ee-preproc** library, together with two additional tools:
